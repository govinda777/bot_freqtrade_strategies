...
# IAM Role para a execução do ArgoCD
resource "aws_iam_role" "argocd" {
  name = "argocd-role-${var.environment}"
...
# Política para o ArgoCD para permitir acesso ao ECR
resource "aws_iam_role_policy" "argocd_ecr_policy" {
  name   = "argocd-ecr-policy-${var.environment}"
